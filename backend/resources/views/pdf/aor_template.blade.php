        ...
        <div class="photo-section">
            ...
            <div class="section">
                ...
                <div class="content">
                    ...
                    <p>Debug info: photos array = {{ isset($report->data['photos']) ? 'exists' : 'not set' }}</p>
                    <p>Debug info: photos count = {{ isset($report->data['photos']) ? count($report->data['photos']) : 'N/A' }}</p>
                    @if(isset($report->data['photos']))
                    <p>Debug info: photos data = {{ json_encode($report->data['photos']) }}</p>
                    @endif
                </div>
            </div>
            @endif
